...
if (hanchk(theForm.sSearchword.value) == 2 ) {
	alert("Invalid search term! \nPlease use only letters, numbers or special characters.");
	theForm.sSearchword.focus();
	return (false);
}
...
let sword = encodeURIComponent(theForm.sSearchword.value.toUpperCase().trim()).replace("(","%28").replace(")","%29");

if(tmpChk==1) theForm.action = ((bApp)?"//app2.":"//www.")+strLang+"/view.jsp?Searchword=" + sword;
else if(tmpChk==5) theForm.action = ((bApp)?"//app2.":"//www.")+strLang+"/view_datasheet.jsp?Searchword=" + sword;
else if(tmpChk==3) theForm.action = ((bApp)?"//app2.":"//www.")+strLang+"/view_marking.jsp?Searchword=" + sword;
else if(tmpChk==4) theForm.action = ((bApp)?"//app2.":"//www.")+strLang+"/view_package.jsp?Searchword=" + sword;
...
else theForm.action = "//"+((bApp)?"categoryapp":"www")+"."+strLang+((bApp)?"":"/category")+"/index.jsp?sSearchword=" + sword;
